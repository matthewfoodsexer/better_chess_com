const THEMES = {
  default: {
    ...
    btnHoverBg: "#48453f", btnPrimaryBg: "#81b64c", text: "#c5c1bb", sidebarWidth: 220,
  },
  midnight: {
    ...
    btnHoverBg: "#282828", btnPrimaryBg: "#2a2a2a", text: "#cccccc", sidebarWidth: 220,
  },
  charcoal: {
    ...
    btnHoverBg: "#333333", btnPrimaryBg: "#353535", text: "#d0d0d0", sidebarWidth: 220,
  },
  ocean: {
    ...
    btnHoverBg: "#1a2e44", btnPrimaryBg: "#1e3550", text: "#aabbcc", sidebarWidth: 220,
  },
  forest: {
    ...
    btnHoverBg: "#1c2e1c", btnPrimaryBg: "#223822", text: "#aaccaa", sidebarWidth: 220,
  },
  mocha: {
    ...
    btnHoverBg: "#2c2622", btnPrimaryBg: "#332e28", text: "#ccbbaa", sidebarWidth: 220,
  },
  amoled: {
    ...
    btnHoverBg: "#111111", btnPrimaryBg: "#141414", text: "#bbbbbb", sidebarWidth: 220,
  },
  nord: {
    ...
    btnHoverBg: "#4c566a", btnPrimaryBg: "#5e81ac", text: "#d8dee9", sidebarWidth: 220,
  },
  dracula: {
    ...
    btnHoverBg: "#3e4258", btnPrimaryBg: "#6272a4", text: "#d0d4e4", sidebarWidth: 220,
  },
  solarized: {
    ...
    btnHoverBg: "#0e5060", btnPrimaryBg: "#268bd2", text: "#93a1a1", sidebarWidth: 220,
  },
  rose: {
    ...
    btnHoverBg: "#331e28", btnPrimaryBg: "#442838", text: "#ccaabb", sidebarWidth: 220,
  },
};

const DEFAULTS = { theme: true, adblock: true, selectedTheme: "midnight", fontFamily: "system", ...THEMES.midnight };
